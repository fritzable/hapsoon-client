...
class Episode extends Component {
  ...
  render () {
    ...
    const { urls, _id, owner } = this.state.episode
      ...
      <Fragment>
        <Row>
          <Col xs={8} md={10} lg={12}>
            <h6 className='info'>Episode number: { _id }</h6>
            <div>
        ...
        <div>{(owner === this.props.user._id) ? <Fragment>
        ...
        </Fragment> : <p className='info'>Only the creator of this Episode can edit the content.</p>}
        </div>
      </Fragment>
    )
  }
